...
[博客 https://blog.nanshaobit.top/107](https://blog.nanshaobit.top/107)
### 仓库
...
> 此接口原始页面为：
> http://219.230.159.132/web_jxrw/cx_kb_jseskfb.aspx
> 该接口可查任意教室、任意周次的课程情况。
> 
> 由于有同学考研需要，查询空教室， 故开发此功能，仅实现了查询西太湖校区立德楼全天空教室。
> 如果有其他需要，可参考代码自行修改。
 
+ 代码地址 [empty_room.py](empty_room.py)
